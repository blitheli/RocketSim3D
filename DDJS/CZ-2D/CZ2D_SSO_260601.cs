...
{
     /// <summary>
    /// CZ-2D SSO + 500km, 运载能力 1500kg
    /// </summary>
    [TestMethod]
    public void CZ2D_SSO_260601()
    {
        string dirPath = Path.Combine(ScRocketStatic.CurrentDir, "DDJS/CZ-2D");
        string filePath = Path.Combine(dirPath, "CZ2D_SSO_260601.json");
        ...
        Console.WriteLine("");
        Assert.AreEqual(1468.149, profile.OptimX[0], 1.0, "运载能力与预期不符");
