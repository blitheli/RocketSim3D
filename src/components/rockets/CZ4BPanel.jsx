...
export default function CZ4BPanel({
  payload,
  onChange,
  shiXuTable,
  optimizedFields,
  ...
  // 三级剩余推进剂 = 三级推进剂 - 三级发动机燃烧消耗推进剂
  const remaining3 = (Number(input.Stage3_FuelMass) || 0) - burnConsumption(input, 'Stage3_Engine', input.Tk_3)
